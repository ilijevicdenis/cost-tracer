...
namespace WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IRepository<ProductCategoryModel>, ProductCategoryRepository>();
            services.AddTransient<IGetAll<ProductCategoryModels>, ProductCategoryRepository>();
        }
